...
@WebServlet("/mostrarFechas")
public class MostrarFechasServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public MostrarFechasServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/verFechas.jsp").forward(request, response);
	}
