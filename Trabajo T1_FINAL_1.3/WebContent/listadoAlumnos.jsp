...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','780','height','130','src','flash/flash1','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','flash/flash1' ); //end AC code
     ...
     <tr>
       <td width="17%" align="left" valign="top"><table width="100%" border="0" bgcolor="#000000">
           <tr>
...
<%if(alumnos.size()>0){%>
				...
				<table width="94%" border="1">
				  <tr>
				    <td width="14%"><h2><strong>Codigo</strong></h2></td>
				    <td width="16%"><h2><strong>Nombre</strong></h2></td>
				    <td width="15%"><h2><strong>Seccion</strong></h2></td>
				    <td width="15%"><h2><strong>Grupo</strong></h2></td>
				    <td width="17%"><h2><strong>Seccion</strong></h2></td>
				    <td width="23%">&nbsp;</td>
			      </tr>
				  ...
				  <tr>
				    ...
				    <td> <a href="mostrarDetalle?grupo=<%=alumno.getGrupo() %>">mostrar Detalle</a></td>
			      </tr>
                           <% } %>
	     </table>
<%if(mensaje!=null){ %>
     ...
     <tr>
       <td height="76">&nbsp;</td>
       <td height="76"><img src="img2/img_1.fw.png" width="1040" height="70" align="middle"></td>
     </tr>
</table>
</body>
</html>
